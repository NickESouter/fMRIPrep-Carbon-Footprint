#!/bin/bash
#$ -N P0 #Job ID name sent to HPC cluster.
#$ -pe openmp 5 #Number of requested parallel environments.
#$ -o '/<directory root>/fMRIPrep/Pipeline_0/logs' #Folder where fMRIPrep logs files are saved out by the HPC cluster.
...
SCRATCH_DIR=/<directory root>/Pipeline_0/scratch
OUT_DIR=/<directory root>/Pipeline_0/derivatives
LICENSE=/<directory root>/fs_license/license.txt
LOCAL_FREESURFER_DIR=/<directory root>/Pipeline_0/derivatives/sourcedata/freesurfer
